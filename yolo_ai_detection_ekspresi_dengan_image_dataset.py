...
Marco Benedictus Tirtaatmadja 202304560040 <p>
Tawarikh Anggia Cristopher 202304560006 <p>
Leader Siahaan 202304560036 <p>
Candra Ratu 202304560035 <p>
"""
...
# Salin folder hasil training ke Google Drive
...
try:
        ...
        if not uploaded:
            ...
            print(f"\n✅ Hasil deteksi disimpan sebagai: {output_filename}")

            print("Klik link di bawah ini untuk mengunduh gambar hasil:")
...
try:
        ...
        print("\nSilakan upload file video untuk dideteksi:")
        uploaded = files.upload()
        ...
        if not uploaded:
            ...
            print(f"\nVideo '{filename}' berhasil diupload.")
            ...
            while cap.isOpened():
                ...
                results = model_custom(frame, conf=0.4, verbose=False)
            ...
            end_time = time.time()
            print(f"\nProses video selesai dalam {end_time - start_time:.2f} detik.")
